...
public class AssignmentDaoTest {
	...
	public void testGetAllAssignments_positive() {
		 ...
		 * Act
		 */
		List<Assignment> assignments = this.sut.findAll();
		...
		expectedAssignments.add(expected1);
		expectedAssignments.add(expected2);
		expectedAssignments.add(expected3);
		expectedAssignments.add(expected4);
		expectedAssignments.add(expected5);
