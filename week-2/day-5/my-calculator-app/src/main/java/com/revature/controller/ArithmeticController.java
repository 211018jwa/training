...
public class ArithmeticController {
	...
	public ArithmeticService arithmeticService; // instance variable belonging to an instance of ArithmeticController
	...
	public Handler add = (ctx) -> {		
		...
		ctx.result(arithmeticService.doOperation(number1String, number2String, '+')); // Because number1 and number2 are just Strings, this will do String concatentation and not our actual adding of numbers
	};
