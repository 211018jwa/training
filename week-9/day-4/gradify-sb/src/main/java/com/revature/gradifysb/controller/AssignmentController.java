...
public class AssignmentController {
	...
	public ResponseEntity<Object> getAllAssignments() {
		...
		List<Assignment> assignmentsThatBelongToAssociate = as.getAssignments(currentlyLoggedInUser);
		
		return ResponseEntity.status(200).body(assignmentsThatBelongToAssociate);
