...
public class Main {
	...
	public static void main(String[] args) {
		...
		ReimbursementService reimbService = (ReimbursementService) container.getBean("myReimbService");
		System.out.println(reimbService.getAllReimbursements());
		
		ReimbursementService reimbService2 = (ReimbursementService) container.getBean("myReimbService");
