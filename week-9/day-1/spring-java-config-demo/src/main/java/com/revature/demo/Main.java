...
public class Main {
	...
	public static void main(String[] args) {
		...
		ReimbursementService reimbService = (ReimbursementService) container.getBean("myReimbursementService");
		System.out.println(reimbService.getAllReimbursements());
		
		ReimbursementService reimbService2 = (ReimbursementService) container.getBean("myReimbursementService");
		...
		UserService userService = (UserService) container.getBean("myUserService");
